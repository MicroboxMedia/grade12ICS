...
def main():
    ...
    all_star_list = create_star_list(r"stars and constellations - Copy\stars.txt")
    draw_stars_oncanvas(star_canvas, all_star_list)

    #Create data structure for drawing constellations
    named_stars = create_named_star_list(r"stars and constellations - Copy\stars.txt")
    constellations_dict = create_constellations(r"stars and constellations - Copy\constellations.txt")
